...
app.get('/Roadster.png', function (req, res) {
   
    res.sendFile(path.join(__dirname + "/Roadster.png"));

});

app.get('/Gucci.png', function (req, res) {
   
    res.sendFile(path.join(__dirname + "/Gucci.png"));

});

app.get('/HRX.png', function (req, res) {
   
    res.sendFile(path.join(__dirname + "/HRX.png"));

});

app.get('/Moda_Rapido.png', function (req, res) {
   
    res.sendFile(path.join(__dirname + "/Moda_Rapido.png"));
